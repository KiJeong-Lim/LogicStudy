...
\begin{document}
  ...
  \begin{context}[Group I--Axiom Schemes for Propositional Logic]
    \begin{enumerate}
  ...
  \begin{context}[Group II--Additional Axiom Schemes for First-Order Logic with Identity]
    \begin{enumerate}
      ...
      \item[$L_{7} :$] $\left( v_i = t \rightarrow \left( X_1 v_i X_2 \rightarrow \right) \right)$ (단, $X_1$과 $X_2$는 $X_1 v_i X_2$가 원자 논리식이 되게 하는 임의의 표현식임)\footnote
      {
