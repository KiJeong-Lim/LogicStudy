  ...
  \begin{context}[Solutions]
    \begin{enumerate}
      ...
      \begin{itemize}
        ...
        \end{align*}
        이므로,
        논리식 $$ H_A : \equiv \exists v_2 \left( \overline{k} *_{10} \overline{10}^{v_1} *_{10} \overline{89} *_{10} v_1 *_{10} \overline{3} = v_2 \land \exists v_3 \left( v_2 = \overline{2} \times v_3 \right) \right) $$은 집합 $A^{*}$를 표현한다.
        이때 $H_A$의 괴델 수를 $h_A$라 하자.
        그러면 $ H_A \left( h_A \right) $은 $A$의 괴델 문장이 된다.
        한편, $\overline{k} *_{10} \overline{10}^{\overline{h_A}} *_{10} \overline{89} *_{10} \overline{h_A} *_{10} \overline{3}$가 짝수일 때 그리고 그럴 때에만 이 문장이 참인데,
        ...
        \end{align*}
        이므로,
        논리식 $$ H_B : \equiv \exists v_2 \left( \overline{k} *_{10} \overline{10}^{v_1} *_{10} \overline{89} *_{10} v_1 *_{10} \overline{3} = v_2 \land \forall v_3 \lnot \left( v_2 = \overline{2} \times v_3 \right) \right) $$은 집합 $B^{*}$를 표현한다.
        이때 $H_B$의 괴델 수를 $h_B$라 하자.
        그러면 $H_B \left( h_B \right)$은 $B$의 괴델 문장이 된다.
        한편, $\overline{k} *_{10} \overline{10}^{\overline{h_B}} *_{10} \overline{89} *_{10} \overline{h_B} *_{10} \overline{3}$가 홀수일 때 그리고 그럴 때에만 이 문장이 참인데,
