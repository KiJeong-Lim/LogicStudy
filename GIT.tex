  ...
  \begin{context}[Solutions]
    \begin{enumerate}
      ...
      \begin{itemize}
        ...
        \item[(b)] 논리식 $v_1 \neq \overline{1} \left( \forall v_2 \forall v_3 \left( \left( v_1 = v_2 \times v_3 \right) \rightarrow \left( v_2 = \overline{1} \lor v_2 = v_1 \right) \right) \right)$이 모든 소수들의 집합을 표현하기 때문이다.
      \end{itemize}
