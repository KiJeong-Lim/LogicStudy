...
증명은 다음과 같다:
\begin{enumerate}
\item $\mathrm{Seq} \left( x \right) \iff \delta B x \land \delta E x \land \delta \ne x \land \delta \delta \tilde{P} x \land \left( \forall y \le x \right) \left[ \delta 0 y P x \rightarrow \delta B y \right]$
\item $x \in y \iff \mathrm{Seq} \left( y \right) \land \delta x \delta P y \land \delta \tilde{P} x$
...
각각 $x \, \mathrm{imp} \, y$, $\neg \left( x \right)$, $x \, \mathrm{pl} \, y$, $x \, \mathrm{tim} \, y$, $x \, \mathrm{exp} \, y$, $s \left( x \right)$, $x \, \mathrm{id} \, y$와 $x \, \mathrm{le} \, y$로 언급하자.
...
$$ \left( \exists y \le x \right) \left( z \le x \right) \left[ \mathrm{tm}\left( y \right) \land \mathrm{tm}\left( y \right) \land \left( x = y \, \mathrm{id} \, z \lor x = y \, \mathrm {le} \, z \right) \right] $$
