  ...
  \begin{context}[Solutions]
    \begin{enumerate}
      ...
      \begin{itemize}
        ...
        그러면 $H_A \left[ v_1 := \overline{h_A} \right]$은 $A$의 괴델 문장이 된다.
        ...
        이 수의 $10$진 표기의 마지막 숫자는 $3$이므로 $H_A \left[ v_1 := \overline{h_A} \right]$는 거짓임을 알 수 있다.
        ...
        그러면 $H_B \left[ v_1 := \overline{h_B} \right]$은 $B$의 괴델 문장이 된다.
        ...
        이 수의 $10$진 표기의 마지막 숫자는 $3$이므로 $H_B \left[ v_1 := \overline{h_B} \right]$은 참임을 알 수 있다.
      \end{itemize}
