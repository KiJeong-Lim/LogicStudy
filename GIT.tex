...
\begin{document}
  ...
  \begin{context}[Remarks]
    지금 우리가 다루는 언어 $\mathcal{L}_{E}$를 1단원의 추상적인 프레임워크에 적용하기 앞서,
  ...
  \begin{context}[Exercise 8]
    [어려움 주의!] 임의의 $A \subseteq \mathbb{N}$과 임의의 $B \subseteq \mathbb{N}$에 대하여,
  ...
  \begin{context}[Solutions]
    \begin{enumerate}
      \item
      \begin{itemize}
        \item[(a)] 문장 $\left( X \land Y \right)$는 문장 $\lnot \left( X \rightarrow \lnot Y \right)$가 참일 때 그리고 그럴 때에만 참이다.
        \begin{enumerate}
        ...
        \item[(b)] 문장 $\left( X \lor Y \right)$는 문장 $\left( \lnot X \rightarrow Y \right)$이 참일 때 그리고 그럴 때에만 참이다.
        \begin{enumerate}
          \item[(\textit{i})] $X$와 $Y$ 모두 참인 경우를 고려하자.
        ...
        \item[(c)] 논리식 $F$에 자유롭게 나타나는 개체 변수가 $v_i$ 뿐이라고 하자.
        문장 $\exists v_i F$는 $\lnot \forall v_i \lnot F$가 참일 때 그리고 그럴 때에만 참이다.
      ...
      \item $A \subseteq \mathbb{N}$과 $f : \mathbb{N} \to \mathbb{N}$가 싼술적이라고 하자.
      그러면 자유롭게 나타나는 개체 변수가 $v_1$ 뿐인 어떤 논리식 $F_A$와 자유롭게 나타나는 변수가 $v_1$과 $v_2$ 뿐인 어떤 논리식 $F_f$가 존재하여
      ...
      $A \subseteq \mathbb{N}$과 $f : \mathbb{N} \to \mathbb{N}$가 산술적인 경우에는,
      ...
      표현식 $E$에 대하여 각 $x \in \mathbb{N}$와 $y \in \mathbb{N}$마다 $$E \left( x , y \right) : \equiv \forall v_1 \forall v_2 \left( v_1 = \overline{x} \rightarrow \left( v_2 = \overline{y} \rightarrow E \right) \right)$$라고 표기하자.
